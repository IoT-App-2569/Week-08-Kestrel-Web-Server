// ============================================================================
//  ใบงานการทดลองที่ 8.3 : สะพานเชื่อมฮาร์ดแวร์จริงสู่เว็บเซิร์ฟเวอร์
//  รหัสนักศึกษา : 67030098
//  ----------------------------------------------------------------------------
//  สถาปัตยกรรม Producer - Consumer :
//
//     ESP32 --USB--> [SerialBridgeWorker] --> [TelemetryStateStore] --> [/api/telemetry]
//                     (Producer, เธรดเบื้องหลัง)   (หน่วยความจำกลาง)     (Consumer, ตามคำขอ)
//
//  ปัญหาที่ต้องแก้ : Serial Stream ไหลเข้ามาตลอดเวลา (Push) แต่ Web Request
//  เข้ามาเป็นครั้งคราว (Pull) จังหวะเวลาไม่ตรงกัน จึงต้องมีหน่วยความจำกลางคั่น
// ============================================================================
