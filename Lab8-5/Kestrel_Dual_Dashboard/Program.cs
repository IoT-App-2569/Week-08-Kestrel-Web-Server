...
// กำหนดให้ Kestrel รันที่ Localhost Port 5000
...
// API Endpoint ส่งข้อมูล Telemetry แบบ 2 ช่องสัญญาณ
app.MapGet("/api/telemetry", (DualChannelStateStore state) => Results.Ok(state.GetSnapshot()));

app.Run();

// ====================================================================
// Thread-Safe State Store คลังเก็บข้อมูลเซนเซอร์ 2 ช่องสัญญาณ
// ====================================================================
    ...
    public object GetSnapshot()
    {
        lock (_lock)
        {
            return new
            {
                ...
                channelB = new
                {
                    name = "Sensor B (Simulated Sine B)",
                    rawValue = _rawB,
...
// ====================================================================
// Background Worker ดักอ่าน Serial Port และ Fallback Simulation
// ====================================================================
public class DualSerialBridgeWorker : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            // Fallback จำลองข้อมูลเมื่อไม่ได้เสียบสาย USB ESP32
