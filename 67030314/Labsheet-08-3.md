...
2. กด Refresh (F5) บนหน้าเบราว์เซอร์หลายๆ ครั้งติดต่อกัน สังเกตว่า:
   ...
   - **คำตอบ:** ค่า dataSource จะเปลี่ยนเป็น **"Simulation Mode (2 Channels)"** (หรือโหมดจำลอง) ส่วนค่า rawValue ยังคงเปลี่ยนได้อยู่ โดยจะไม่ค้างเป็น 0 แต่จะเปลี่ยนค่าเพิ่ม-ลดอย่างต่อเนื่องเป็นจังหวะตามรูปแบบคลื่นฟังก์ชัน ที่ระบบ Fallback สร้างขึ้นมาทดแทนสัญญาณจริง
