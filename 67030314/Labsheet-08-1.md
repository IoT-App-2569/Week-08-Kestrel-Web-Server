...
2. กลับไปที่หน้าเบราว์เซอร์แล้วกดปุ่ม **Refresh (F5)** สังเกตว่าเกิดอะไรขึ้น และอธิบายสั้นๆ ว่าทำไมจึงเป็นเช่นนั้น
   - **คำตอบ** เบราว์เซอร์จะขึ้นหน้าจอข้อความแสดงข้อผิดพลาด ไม่สามารถติดต่อเซิร์ฟเวอร์ได้ เนื่องจาก Kestrel Web Server ถูกยกเลิกหยุดให้บริการไปทำให้ไม่มีส่วนของแอปพลิเคชันมารอรับการเชื่อมต่อ HTTP Request
...
- **คำตอบ** ตัวแปร builder ทำหน้าที่ตั้งค่าการทำงานและลงทะเบียนบริการต่างๆของเว็บแอปพลิเคชัน ส่วนตัวแปร app ทำหน้าที่บริหารจัดการคำขอ HTTP และกำหนดการจับคู่อัตโนมัติไปยัง API
...
- **คำตอบ** .NET Minimal API โดดเด่นด้านความรวดเร็ว ประสิทธิภาพการประมวลผลสูง และมี Thread-Safe Store ที่สื่อสารกับฮาร์ดแวร์ Serial Port ได้โดยตรง ในขณะที่ LAMP Stack ติดตั้งง่าย ปรับแต่งหน้าเว็บสะดวกกว่า แต่กินทรัพยากรมากกว่าและจัดการสายสื่อสาร Real-time กับฮาร์ดแวร์ได้ยาก

3. นักศึกษาคิดว่าการเพิ่ม `/api/` เข้าไปใน route นั้นมีประโยชน์อย่างไรบ้าง ถ้าไม่ใส่จะเกิดปัญหาอะไรบ้าง
- **คำตอบ** การใส่ /api/ ช่วยแบ่งแยกเส้นทางการร้องขอข้อมูลแบบ JSON ออกจากไฟล์หน้าเว็บทั่วไปหากไม่ใส่ อาจเกิดปัญหาเส้นทางตีกันกับชื่อไฟล์และทำให้การตั้งค่าความปลอดภัยหรือการแยกส่วนจัดการระบบทำได้ยุ่งยาก