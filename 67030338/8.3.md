...
2. กด Refresh (F5) บนหน้าเบราว์เซอร์หลายๆ ครั้งติดต่อกัน สังเกตว่า:
   ...
   - คำตอบ:  เปลี่ยนเป็น **`"Simulation Mode (Sine Wave)"`**
   - ค่า `rawValue` ยังเปลี่ยนได้อยู่หรือไม่ และเปลี่ยนในลักษณะใด?
   - **คำตอบ:** .**ยังคงเปลี่ยนแปลงได้อยู่** โดยเปลี่ยนในลักษณะ **ทยอยเพิ่มขึ้นและลดลงอย่างนุ่มนวลเป็นจังหวะตามรูปคลื่นไซน์ (Sine Wave)** ในช่วงค่าระหว่าง `0` ถึง `4095`
<img width="957" height="402" alt="a" src="https://github.com/user-attachments/assets/2151e271-944d-4d84-b7ff-7c8fa2fe5ea7" />
<img width="995" height="411" alt="b" src="https://github.com/user-attachments/assets/06290def-12d0-4b6c-bea7-7c598889a38c" />
